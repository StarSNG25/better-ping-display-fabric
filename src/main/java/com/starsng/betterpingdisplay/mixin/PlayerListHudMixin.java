...
import com.starsng.betterpingdisplay.hud.CustomPlayerListHud;
...
public abstract class PlayerListHudMixin
{
	...
	/**
	 * Increases the int constant {@code 13} in the {@link PlayerListHud#render}
	 * method by {@value #PLAYER_SLOT_EXTRA_WIDTH}. This constant is used to define
	 * the width of the "slots" in the player list. In order to fit the ping text,
	...
	/**
	 * Redirects the call to {@code renderLatencyIcon} in
	 * {@link PlayerListHud#render} to instead call
