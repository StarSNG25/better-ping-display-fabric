...
**Forked to keep the mod updated.**


A [Fabric](https://fabricmc.net/) mod for Minecraft to display each player's ping in the player list as a number.

![](https://raw.githubusercontent.com/StarSNG25/better-ping-display-fabric/refs/heads/1.21.x/src/main/resources/assets/betterpingdisplay/icon.png)
...
|---|---|---|
| autoColorPingText  | `true` | Whether to color a player's ping based on their latency; low latency = green, moderate latency = amber, high latency = red |
